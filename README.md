...
|"Поколение Python": курс для начинающих|Ввод-вывод данных, Условный оператор, Типы данных,  Циклы for и while, Строковый тип данных, Списки, Функции, Мини-проекты, промежуточные экзамены|[сертификат](https://stepik.org/cert/1748777)|
  <!--
